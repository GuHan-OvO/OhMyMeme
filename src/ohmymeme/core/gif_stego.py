...
CLI 用法：
    编码：python -m ohmymeme.core.gif_stego encode 转换后的.gif 原图.jpg 输出.gif
    解码：python -m ohmymeme.core.gif_stego decode 输出.gif 还原图.png

库用法（由应用调用）：
    from ohmymeme.core.gif_stego import make_stego_gif, decode
